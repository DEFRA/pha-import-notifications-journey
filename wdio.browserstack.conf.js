...
export const config = {
  ...
  baseUrl: `https://pha-import-notifications-journey.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `pha-import-notifications-journey-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `pha-import-notifications-journey-${process.env.ENVIRONMENT}`
        },
